...
class WorldController:
	...
	def lower_boat_gear(self, world):
		return World(world.size, self.boat_controller.lower_gear(world.boat))
		
	def turn_boat_left(self, world):
		return World(world.size, self.boat_controller.turn_left(world.boat))
		
	def turn_boat_right(self, world):
		return World(world.size, self.boat_controller.turn_right(world.boat))
