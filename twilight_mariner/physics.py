...
class PhysicsObjectController:
	...
	def get_resultant_vel_with_force(self, obj, force):
		return (obj.vel[0] + force[0] * math.cos(force[1]), obj.vel[1] + force[0] * math.sin(force[1]))

	def apply_angular_force(self, obj, force):
		return obj.with_angular_vel(obj.angular_vel + force * obj.angular_vel_force_multiplier)
		
	def get_resultant_angular_vel_with_force(self, obj, force):
		return obj.angular_vel + force * obj.angular_vel_force_multiplier
